...
const BENEFITS = [
  {
    ...
    description: "Whole, nutrient-dense foods provide clean fuel for the body, eliminating the energy crashes caused by processed sugars and junk food.",
  },
  {
    title: "Strengthened Immunity",
    description: "A diet rich in vitamins, minerals, and antioxidants builds a resilient immune system, helping the body naturally ward off illnesses.",
  },
  {
    title: "Sharper Mental Clarity",
    description: "What you eat directly impacts brain health. Clean eating reduces brain fog, improves focus, and helps balance mood and anxiety levels.",
  },
  {
    title: "Radiant Skin & Healthy Aging",
    description: "True beauty starts from the inside. Eating fresh, nutrient-rich foods nourishes your cells, giving you a natural, healthy glow.",
  },
];

const PROMISES = [
  "No junk", "No chemicals", "No sugar", "No refined oils", "No compromises",
];
    ...
    <div className="bg-parchment">
      ...
      <section className="relative overflow-hidden bg-veda-green py-20 text-parchment lg:py-28">
        ...
        <div className="relative mx-auto max-w-4xl px-5 text-center lg:px-8">
          ...
          <p className="mt-8 max-w-2xl mx-auto text-base leading-relaxed text-parchment/80">
            ...
            <em className="text-hitham-gold">Hitham</em> (beneficial, good). Together they form our
            core mission: bringing the timeless benefits of ancient Ayurvedic wisdom into modern
            daily life.
          </p>
        ...
        <div className="grid gap-12 lg:grid-cols-2 lg:items-center">
          <div>
            ...
            <div className="mt-6 flex flex-col gap-4 text-base leading-relaxed text-ink-soft">
              <p>
                Ashwini Reddy — a certified Ayurvedic Nutritionist — was always health-conscious and a passionate
                food lover who found it difficult to eat clean, hygienic food outside. She began researching
                clean, guilt-free, and preservative-free foods.
              </p>
              <p>
                She tried many recipes in her own kitchen. What began as her personal journey became a
                community proving that <strong className="text-veda-green">healthy never has to be boring.</strong>
              </p>
              <p>
                Every recipe and every product carries her promise:
              </p>
            </div>
            ...
            <p className="mt-4 text-sm italic text-ink-soft">
              "We aren't just selling a product; we are sharing a heritage of well-being
          ...
          <div className="flex flex-col gap-5">
            <div className="rounded-2xl border border-hitham-gold/30 bg-hitham-gold-dim p-6">
              ...
              <p className="mt-3 text-sm leading-relaxed text-ink-soft">
                To become India's most trusted name in native, sustainable food — one that future
                generations associate with the taste of home and the wisdom of tradition.
              </p>
            </div>
      ...
      <section className="border-t border-cream-border bg-veda-green py-14 text-center text-parchment">
        <p className="text-xs uppercase tracking-[0.2em] text-hitham-gold">Learn more</p>

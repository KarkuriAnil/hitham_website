      ...
      {mobileOpen && (
        <div className="fixed inset-0 z-50 lg:hidden">
          ...
          <div className="absolute right-0 top-0 h-full w-80 max-w-[85vw] bg-parchment shadow-2xl flex flex-col overflow-y-auto">
            ...
            {/* Contact details */}
            <div className="border-t border-cream-border mx-4 pt-4 pb-2 shrink-0">
              <p className="mb-2 text-[10px] uppercase tracking-wide text-hitham-gold font-semibold px-1">
                Contact Us
              </p>
              <Link
                href="tel:9573404039"
              ...
              >
                <div className="flex h-8 w-8 items-center justify-center rounded-full bg-veda-green/10">
              ...
              >
                ...
                <div>
                  ...
                  <p className="font-semibold text-veda-green">Vedahitham@gmail.com</p>
                </div>
              </Link>
              <Link
              ...
              >
                ...
                <div>
                  ...
                  <p className="font-semibold text-veda-green">@hitham_kitchen</p>
                </div>
              </Link>
            </div>
